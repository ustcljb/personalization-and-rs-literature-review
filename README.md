...
- **Search Personalization with Embeddings**, 2016 (https://arxiv.org/pdf/1612.03597.pdf)
   ...
   - Next we train the model by minimize the total marginal value for the same user <img src="https://render.githubusercontent.com/render/math?math=a">* where sum is taken for all relevant triples *(q, u, d)* and all irrelevant triples *(q', u, d')*.
